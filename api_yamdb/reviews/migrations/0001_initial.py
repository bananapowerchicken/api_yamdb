# Generated by Django 3.2 on 2023-01-27 15:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator('^[\\w-]+$', 'username содержит некорректные символы')], verbose_name='Имя пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.SmallIntegerField(validators=[reviews.validators.year_validator], verbose_name='Год создания произведения')),
                ...
                ('genre', models.ManyToManyField(db_index=True, null=True, to='reviews.Genre', verbose_name='Жанр произведения')),
            ],
            options={
